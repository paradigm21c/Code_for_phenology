...
xticks(2007:2:2017-1);


% savefig(gcf,sprintf('%s/Plot_T_Park_comp_X_Year_Y_SOS_Slope_%s_%s_2018.fig',path_figure,product,vin{vi}))
% saveas(gcf,sprintf('%s/Plot_T_Park_comp_X_Year_Y_SOS_Slope_%s_%s_2018.png',path_figure,product,vin{vi}))

savefig(gcf,sprintf('%s/Plot_T_Park_comp_X_Year_Y_SOS_Slope_%s_%s_mv12.fig',path_figure,product,vin{vi}))
saveas(gcf,sprintf('%s/Plot_T_Park_comp_X_Year_Y_SOS_Slope_%s_%s_mv12.png',path_figure,product,vin{vi}))
