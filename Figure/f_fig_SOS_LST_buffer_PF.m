...
VANUI_buffer100 = importdata(sprintf('D:/SetoLab/Phenology/data_cal/VANUI/VANUI_buffer_%s_DS_buff%d_%s.mat',product,parks_files(1),name_vis{vi}));
VANUI_buffer200 = importdata(sprintf('D:/SetoLab/Phenology/data_cal/VANUI/VANUI_buffer_%s_DS_buff%d_%s.mat',product,parks_files(2),name_vis{vi}));
VANUI_buffer300 = importdata(sprintf('D:/SetoLab/Phenology/data_cal/VANUI/VANUI_buffer_%s_DS_buff%d_%s.mat',product,parks_files(3),name_vis{vi}));
VANUI_diff100 = importdata(sprintf('D:/SetoLab/Phenology/data_cal/VANUI/VANUI_diff_%s_DS_buff%d_%s.mat',product,parks_files(1),name_vis{vi}));
VANUI_diff200 = importdata(sprintf('D:/SetoLab/Phenology/data_cal/VANUI/VANUI_diff_%s_DS_buff%d_%s.mat',product,parks_files(2),name_vis{vi}));
VANUI_diff300 = importdata(sprintf('D:/SetoLab/Phenology/data_cal/VANUI/VANUI_diff_%s_DS_buff%d_%s.mat',product,parks_files(3),name_vis{vi}));
...
for yr = 1:length(years)
    ...
    savefig(gcf,sprintf('%s/Boxchart_T_Year_%d_X_Park_size_Y_%s_%s_%s_10m_int.fig',path_figure,years(yr), phenology_names{phn},product,name_vis{vi}))
    saveas(gcf,sprintf('%s/Boxchart_T_Year_%d_X_Park_size_Y_%s_%s_%s_10m_int.png',path_figure,years(yr), phenology_names{phn},product,name_vis{vi}))
    ...
    savefig(gcf,sprintf('%s/Radarchart_T_Year_%d_X_Park_size_Y_%s_%s_%s_10m_int.fig',path_figure,years(yr), phenology_names{phn},product,name_vis{vi}))
    saveas(gcf,sprintf('%s/Radarchart_T_Year_%d_X_Park_size_Y_%s_%s_%s_10m_int.png',path_figure,years(yr), phenology_names{phn},product,name_vis{vi}))
end
...
for ps = 1:length(park_size_name)
    ...
    savefig(gcf,sprintf('%s/Boxchart_T_Park_%s_X_Year_Y_%s_%s_%s_10m_int_10m_width.fig',path_figure,park_size_name{ps}, phenology_names{phn},product,name_vis{vi}))
    saveas(gcf,sprintf('%s/Boxchart_T_Park_%s_X_Year_Y_%s_%s_%s_10m_int_10m_width.png',path_figure,park_size_name{ps}, phenology_names{phn},product,name_vis{vi}))
    ...
    savefig(gcf,sprintf('%s/Radarchart_T_Park_%s_X_Year_Y_%s_%s_%s_10m_int_10m_width.fig',path_figure,park_size_name{ps}, phenology_names{phn},product,name_vis{vi}))
    saveas(gcf,sprintf('%s/Radarchart_T_Park_%s_X_Year_Y_%s_%s_%s_10m_int_10m_width.png',path_figure,park_size_name{ps}, phenology_names{phn},product,name_vis{vi}))
...
for ps = 1:length(park_size_name)
    ...
    savefig(gcf,sprintf('%s/Plot_mean_T_Park_%s_X_Year_Y_%s_%s_%s_10m_int_10m_width.fig',path_figure, park_size_name{ps}, phenology_names{phn},product,name_vis{vi}))
    saveas(gcf,sprintf('%s/Plot_mean_T_Park_%s_X_Year_Y_%s_%s_%s_10m_int_10m_width.png',path_figure, park_size_name{ps}, phenology_names{phn},product,name_vis{vi}))
...
for ps = 1:length(park_size_name)
    ...
    savefig(gcf,sprintf('%s/Boxchart_T_Park_%s_X_Year_Y_%s_%s_%s_20m_int_20m_width.fig',path_figure,park_size_name{ps}, phenology_names{phn},product,name_vis{vi}))
    saveas(gcf,sprintf('%s/Boxchart_T_Park_%s_X_Year_Y_%s_%s_%s_20m_int_20m_width.png',path_figure,park_size_name{ps}, phenology_names{phn},product,name_vis{vi}))
    ...
    savefig(gcf,sprintf('%s/Radarchart_T_Park_%s_X_Year_Y_%s_%s_%s_20m_int_20m_width.fig',path_figure,park_size_name{ps}, phenology_names{phn},product,name_vis{vi}))
    saveas(gcf,sprintf('%s/Radarchart_T_Park_%s_X_Year_Y_%s_%s_%s_20m_int_20m_width.png',path_figure,park_size_name{ps}, phenology_names{phn},product,name_vis{vi}))
...
for ps = 1:length(park_size_name)
    ...
    savefig(gcf,sprintf('%s/Plot_mean_T_Park_%s_X_Year_Y_%s_%s_%s_20m_int_20m_width.fig',path_figure,park_size_name{ps}, phenology_names{phn},product,name_vis{vi}))
    saveas(gcf,sprintf('%s/Plot_mean_T_Park_%s_X_Year_Y_%s_%s_%s_20m_int_20m_width.png',path_figure,park_size_name{ps}, phenology_names{phn},product,name_vis{vi}))
...
for ps = 1:length(park_size_name)
    ...
    % hold off
    % 
    % savefig(gcf,sprintf('%s/Boxchart_T_Park_%s_X_Year_Y_%s_%s_%s_20m_int_10m_width.fig',path_figure,park_size_name{ps}, phenology_names{phn},product,name_vis{vi}))
    % saveas(gcf,sprintf('%s/Boxchart_T_Park_%s_X_Year_Y_%s_%s_%s_20m_int_10m_width.png',path_figure,park_size_name{ps}, phenology_names{phn},product,name_vis{vi}))
...
for ps = 1:length(park_size_name)
    ...
    savefig(gcf,sprintf('%s/Plot_mean_T_Park_%s_X_Year_Y_%s_%s_%s_20m_int_10m_width.fig',path_figure,park_size_name{ps}, phenology_names{phn},product,name_vis{vi}))
    saveas(gcf,sprintf('%s/Plot_mean_T_Park_%s_X_Year_Y_%s_%s_%s_20m_int_10m_width.png',path_figure,park_size_name{ps}, phenology_names{phn},product,name_vis{vi}))
...
for yr = 1:length(years)
    for ps = 1:length(park_size_name)
        ...
        LST_100 = reshape(permute(LST_diff100(ind_temp,yr+18,phn),[2 1]),[],1);
        LST_200 = reshape(permute(LST_diff200(ind_temp,yr+18,phn),[2 1]),[],1);
        LST_300 = reshape(permute(LST_diff300(ind_temp,yr+18,phn),[2 1]),[],1);
...
for int = 10:10:50
    ...
    savefig(gcf,sprintf('%s/Dscatter_X_annual_LST_Y_%s_%s_%s_%dm_int_edge.fig',path_figure, phenology_names{phn},product,name_vis{vi},int))
    saveas(gcf,sprintf('%s/Dscatter_X_annual_LST_Y_%s_%s_%s_%dm_int_edge.png',path_figure, phenology_names{phn},product,name_vis{vi},int))
end
