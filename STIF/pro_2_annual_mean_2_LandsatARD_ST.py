...
def main():
    ...
    input_directory = r"D:\SetoLab\Landsat_ARD\PF_extent_ST" 
    output_directory = r"D:\SetoLab\Landsat_ARD\PF_clear_ST"
    annual_mean_output_directory = r"D:\SetoLab\Landsat_ARD\Annual_Mean_PF"
    ...
    for file in clear_files:
        ...
        files_by_year_sensor[year].append(file)

    for year, files in files_by_year_sensor.items():
        annual_mean_output_path = os.path.join(annual_mean_output_directory, f'mean_{year}.tif')
